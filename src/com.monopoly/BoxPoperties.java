...
public class BoxPoperties
{
    ...
    public Component getLabel(String ab)
    {
        ...
        {
            a = (JLabel) SubObjects.get(0);
        }
        else if (name.equals("Baltic Avenue"))
        {
            a = (JLabel) SubObjects.get(1);
        }
        else if (name.equals("Oriental Avenue"))
        {
            a = (JLabel) SubObjects.get(2);
        }
        else if (name.equals("Vermont Avenue"))
        {
            a = (JLabel) SubObjects.get(3);
        }
        else if (name.equals("Connecticut Avenue"))
        {
            a = (JLabel) SubObjects.get(4);
        }
        else if (name.equals("St. Charles Place"))
        {
            a = (JLabel) SubObjects.get(5);
        }
        else if (name.equals("States Avenue"))
        {
            a = (JLabel) SubObjects.get(6);
        }
        else if (name.equals("Virginia Avenue"))
        {
            a = (JLabel) SubObjects.get(7);
        }
        else if (name.equals("St. James Place"))
        {
            a = (JLabel) SubObjects.get(8);
        }
        else if (name.equals("Tennessee Avenue"))
        {
            a = (JLabel) SubObjects.get(9);
        }
        else if (name.equals("New York Avenue"))
        {
            a = (JLabel) SubObjects.get(10);
        }
        else if (name.equals("Kentucky Avenue"))
        {
            a = (JLabel) SubObjects.get(11);
        }
        else if (name.equals("Indiana Avenue"))
        {
            a = (JLabel) SubObjects.get(12);
        }
        else if (name.equals("Illinois Avenue"))
        {
            a = (JLabel) SubObjects.get(13);
        }
        else if (name.equals("Atlantic Avenue"))
        {
            a = (JLabel) SubObjects.get(14);
        }
        else if (name.equals("Ventor Avenue"))
        {
            a = (JLabel) SubObjects.get(15);
        }
        else if (name.equals("Marvin Gardens"))
        {
            a = (JLabel) SubObjects.get(16);
        }
        else if (name.equals("Pacific Avenue"))
        {
            a = (JLabel) SubObjects.get(17);
        }
        else if (name.equals("North Carolina Avenue"))
        {
            a = (JLabel) SubObjects.get(18);
        }
        else if (name.equals("Pennsylvania Avenue"))
        {
            a = (JLabel) SubObjects.get(19);
        }
        else if (name.equals("Park Place"))
        {
            a = (JLabel) SubObjects.get(20);
        }
        else if (name.equals("Boardwalk"))
        {
            a = (JLabel) SubObjects.get(21);
        }
        else if (name.equals("Go Start"))
        {
            a = (JLabel) ExtrasObjects.get(0);
        }
        else if (name.equals("Community Chest South"))
        {
            a = (JLabel) ExtrasObjects.get(1);
        }
        else if (name.equals("Income Tax"))
        {
            a = (JLabel) ExtrasObjects.get(2);
        }
        else if (name.equals("Reading Railroad"))
        {
            a = (JLabel) ExtrasObjects.get(3);
        }
        else if (name.equals("Chance South"))
        {
            a = (JLabel) ExtrasObjects.get(4);
        }
        else if (name.equals("Just Visiting or In Jail"))
        {
            a = (JLabel) ExtrasObjects.get(5);
        }
        else if (name.equals("Electric Company"))
        {
            a = (JLabel) ExtrasObjects.get(6);
        }
        else if (name.equals("Pennsylvania Railroad"))
        {
            a = (JLabel) ExtrasObjects.get(7);
        }
        else if (name.equals("Community Chest West"))
        {
            a = (JLabel) ExtrasObjects.get(8);
        }
        else if (name.equals("Free Parking"))
        {
            a = (JLabel) ExtrasObjects.get(9);
        }
        else if (name.equals("Chance North"))
        {
            a = (JLabel) ExtrasObjects.get(10);
        }
        else if (name.equals("B and O Railroad"))
        {
            a = (JLabel) ExtrasObjects.get(11);
        }
        else if (name.equals("Waterworks"))
        {
            a = (JLabel) ExtrasObjects.get(12);
        }
        else if (name.equals("Go To Jail"))
        {
            a = (JLabel) ExtrasObjects.get(13);
        }
        else if (name.equals("Community Chest East"))
        {
            a = (JLabel) ExtrasObjects.get(14);
        }
        else if (name.equals("Short Line"))
        {
            a = (JLabel) ExtrasObjects.get(15);
        }
        else if (name.equals("Chance East"))
        {
            a = (JLabel) ExtrasObjects.get(16);
        }
        else if (name.equals("Luxury Tax"))
        {
            a = (JLabel) ExtrasObjects.get(17);
        }
        else if (name.equals("Center"))
        {
            a = (JLabel) ExtrasObjects.get(18);
        }
        else
        {
            a = new JLabel(PennsylvaniaAvenue);
        }
